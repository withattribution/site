...
exports.tumblr = function(req, res) {
  ...
  // console.log("req.useragent.isiPad: "+req.useragent.isiPad);
  blog.posts({ 
   ...
   function(error, response) {
    ...
    _.each(response.posts, function (post) { 
      var picked = _.pick(post,'id','type','tags','caption','video_url','thumbnail_url');
    ...
    // console.log("total_posts: "+response.total_posts );
